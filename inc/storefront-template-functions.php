...
if ( ! function_exists( 'storefront_site_title_or_logo' ) ) {
	...
	function storefront_site_title_or_logo( $echo = true ) {
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
			...
			$logo = '<img src="https://devultrachem.wpengine.com//wp-content/themes/ultrachem-custom/UltraChem_Logo@2x.svg">';
			//$html = is_home() ? '<h1 class="logo">' . $logo . '</h1>' : $logo;
			$html = '<h1 class="logo"><img src="https://devultrachem.wpengine.com//wp-content/themes/ultrachem-custom/UltraChem_Logo@2x.svg"></h1>'s;
		} else {
			$tag = is_home() ? 'h1' : 'div';
