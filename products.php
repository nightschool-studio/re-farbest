<?php
/**
 * Template name: products filter page
 *
...
div.formcraft-css.body-append.image_button_cover.placement-right.now-show {display:none;}
	...
	<div class="pm_product_filter" style="width:240px;float:left;margin-top:167px;"><?php if( is_active_sidebar( 'widgetized-page-before-content-widget-area' ) ) : ?>
